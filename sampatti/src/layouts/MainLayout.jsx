...
const MainLayout = () => {
  ...
  useEffect(() => {
    ...
    else if (path.includes('/investments')) setPageTitle('Investments');
    else if (path.includes('/documents')) setPageTitle('Documents');
    else if (path.includes('/nominees')) setPageTitle('Nominees');
    else if (path.includes('/alerts')) setPageTitle('Alerts');
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-gray-100">
      <header className="md:hidden bg-gray-800 p-4 border-b border-gray-700 flex justify-between items-center">
        ...
        <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="p-2 rounded-lg hover:bg-gray-700">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="hidden md:flex md:w-64 bg-gray-800 border-r border-gray-700 flex-col">
            ...
            <ul>
              <li className="mb-2">
                <NavLink to="/dashboard" className={({isActive}) => 
                  isActive ? "flex items-center p-3 rounded-lg bg-indigo-600 text-white" 
              ...
              <li className="mb-2">
                <NavLink to="/nominees" className={({isActive}) => 
                  isActive ? "flex items-center p-3 rounded-lg bg-indigo-600 text-white" 
                  : "flex items-center p-3 rounded-lg hover:bg-gray-700 text-gray-300"}>
          ...
          <div className="p-4 border-t border-gray-700">
            <button onClick={handleLogout} className="flex items-center p-3 rounded-lg hover:bg-gray-700 text-gray-300 w-full">
          ...
          <div className="md:hidden absolute inset-0 z-50 bg-gray-900 pt-16">
            <nav className="px-4 py-2">
              <ul>
                <li className="mb-2">
                  <NavLink to="/dashboard" className={({isActive}) => 
                    isActive ? "flex items-center p-4 rounded-lg bg-indigo-600 text-white" 
                ...
                <li className="mt-6">
                  <button onClick={handleLogout} className="flex items-center p-4 rounded-lg hover:bg-gray-700 text-gray-300 w-full">
                    <LogOut size={20} className="mr-3" />
                    <span>Log out</span>
                  </button>
                </li>
